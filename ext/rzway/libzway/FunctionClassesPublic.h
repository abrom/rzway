...
// @report: devices[node_id].data.lastSend
//
ZWEXPORT ZWError zway_fc_send_data_secure(ZWay zway, ZWBYTE node_id, ZWBYTE length, const ZWBYTE *data, ZWCSTR description, ZJobCustomCallback successCallback, ZJobCustomCallback failureCallback, void* callbackArg);
